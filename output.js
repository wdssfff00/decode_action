//Mon Nov 04 2024 17:57:15 GMT+0000 (Coordinated Universal Time)
  ...
  if (iiiI1I) {
    if (iill1i) {
      if (iill1i < maxexchange) {
        ...
        if (iill1i <= 100) await $.wait(3000), await l1Ii1("1", "100"), await $.wait(1000);else {
          await $.wait(3000);
...
function ili1i() {
  return new Promise(async iIlI1i => {
    ...
    $.post(iII1Ii, (l1l11, illill, IIIli1) => {
      try {
        if (l1l11) console.log("" + JSON.stringify(l1l11)), console.log($.name + " jingBeanDetail API请求失败，请检查网路重试");else {
          if (IIIli1) {
